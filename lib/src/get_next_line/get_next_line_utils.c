...
/*   Updated: 2023/01/22 17:10:28 by itopchu       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char const *s1, char const *s2)
{
	...
	if (s1 == NULL || s2 == NULL)
		return (NULL);
	s1_len = ft_strlen_var((char *)s1, '\0');
	s2_len = ft_strlen_var((char *)s2, '\0');
